...
module.exports = function(io){
    ...
    var default_group = {group_name:'Lobby', group_hash: '0d4c3d1b3f0c14e4aae9e9598ed745db', group_type: 'group'};
    ...
    socket.on('add user', (username) => {
        ...
        callUsersPromise().then(function(user) {
            ...
            for(var user_group of user.groups) {
                ...
                console.log('user group join => '+ username + ', group => '+ user_group.group_name + ', group hash ' + user_group.group_hash);
            ...
            */
            ...
            if(socket.room_hash == default_group.group_hash){
            ...
            socket.emit('updatechat', 'SERVER', {username: socket.username, group_name: default_group.group_name, 'group_hash':default_group.group_hash, msg:'you have connected to ' + default_group.group_name});
    ...
    */
    ...
    socket.on('new message', (data) => {
        ...
        */
        ...
        console.log('new msg => ' + data + ', room hash => ' + socket.room_hash);
        ...
        if(group_id !== undefined){
            ...
            GroupsModel.findOne({hash_name:hashUserGroup}, function (err, group, next) {
                ...
                if (!group) {
                    ...
                    // a document instance
                    var groupUserFriend = new GroupsModel({type:'friend', name:group_id, hash_name:hashUserGroup, members:members});
                    ...
                    groupUserFriend.save(function (err, group) {
                        ...
                        //userGroups[socket.user_id].push({group_id:group._id, group_name:data.friendName, 'group_hash':hashUserGroup, group_type:'friend'});

                        //var new_group = {group_name:data.friendName, group_hash: hashUserGroup, group_type: 'friend'};
                        //call_update_room(new_group);
                    ...
                    userGroups.forEach(function(group){
                        console.log('list group => ' + group.group_name);
                    });
